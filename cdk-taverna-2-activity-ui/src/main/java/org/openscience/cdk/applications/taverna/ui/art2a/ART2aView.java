...
public class ART2aView extends JPanel {
	...
	public ART2aView() {
		...
		springLayout.putConstraint(SpringLayout.NORTH, lblUpperVigilanceParameter, 17, SpringLayout.SOUTH, lblNumberOfClassifications);
		...
		springLayout.putConstraint(SpringLayout.NORTH, lblLowerVigilanceParameter, 17, SpringLayout.SOUTH, lblUpperVigilanceParameter);
		...
		springLayout.putConstraint(SpringLayout.WEST, numberOfClassificationsTextField, 0, SpringLayout.EAST, lblNumberOfClassifications);
		springLayout.putConstraint(SpringLayout.EAST, numberOfClassificationsTextField, 40, SpringLayout.EAST, lblNumberOfClassifications);
		...
		springLayout.putConstraint(SpringLayout.NORTH, upperVigilanceLimitTextField, 10, SpringLayout.SOUTH, numberOfClassificationsTextField);
		springLayout.putConstraint(SpringLayout.WEST, upperVigilanceLimitTextField, 0, SpringLayout.EAST, lblUpperVigilanceParameter);
		springLayout.putConstraint(SpringLayout.EAST, upperVigilanceLimitTextField, 40, SpringLayout.EAST, lblUpperVigilanceParameter);
		add(upperVigilanceLimitTextField);
		upperVigilanceLimitTextField.setColumns(10);
		
		lowerVigilanceLimitTextField = new JTextField();
		springLayout.putConstraint(SpringLayout.NORTH, lowerVigilanceLimitTextField, 10, SpringLayout.SOUTH, upperVigilanceLimitTextField);
		springLayout.putConstraint(SpringLayout.WEST, lowerVigilanceLimitTextField, 0, SpringLayout.EAST, lblLowerVigilanceParameter);
		springLayout.putConstraint(SpringLayout.EAST, lowerVigilanceLimitTextField, 40, SpringLayout.EAST, lblLowerVigilanceParameter);
		...
		springLayout.putConstraint(SpringLayout.WEST, lblMaximumClassificationTimew, 10, SpringLayout.EAST, numberOfClassificationsTextField);
		springLayout.putConstraint(SpringLayout.EAST, lblMaximumClassificationTimew, 175, SpringLayout.EAST, numberOfClassificationsTextField);
		add(lblMaximumClassificationTimew);
		
		scaleFingerprintItemsCheckBox = new JCheckBox("Scale fingerprint items");
		springLayout.putConstraint(SpringLayout.NORTH, scaleFingerprintItemsCheckBox, 42, SpringLayout.SOUTH, lblMaximumClassificationTimew);
		springLayout.putConstraint(SpringLayout.WEST, scaleFingerprintItemsCheckBox, 40, SpringLayout.EAST, upperVigilanceLimitTextField);
		springLayout.putConstraint(SpringLayout.EAST, scaleFingerprintItemsCheckBox, 200, SpringLayout.EAST, upperVigilanceLimitTextField);
		...
		springLayout.putConstraint(SpringLayout.WEST, maximumClassificationTimeTextField, 0, SpringLayout.EAST, lblMaximumClassificationTimew);
		springLayout.putConstraint(SpringLayout.EAST, maximumClassificationTimeTextField, 40, SpringLayout.EAST, lblMaximumClassificationTimew);
