...
public class ReactionEnumeratorConfigurationPanel extends
	...
	private JCheckBox useVariableRegionCheckerCheckBox;
	private JCheckBox useMultiMatchCheckerCheckBox;
	...
	protected void initGUI() {
		try {
			...
			this.useVariableRegionCheckerCheckBox = new JCheckBox("Use Variable Region Checker", true);
			this.add(this.useVariableRegionCheckerCheckBox);
			this.useMultiMatchCheckerCheckBox = new JCheckBox("Use Multi Match Checker", true);
	...
	public boolean isConfigurationChanged() {
		...
		if (!(numberOfPorts == oldValue)) {
			return true;
				...
				.getAdditionalProperty(ReactionEnumeratorActivity.USE_MULTI_MATCH_CHECKER) != null)) {
			return true;
		} else if (this.useVariableRegionCheckerCheckBox.isSelected() != (this.configBean
				.getAdditionalProperty(ReactionEnumeratorActivity.USE_VARIABLE_REGION_CHECKER) != null)) {
			return true;
		}
		return false;
	}
	...
	public void noteConfiguration() {
		...
		if (this.useMultiMatchCheckerCheckBox.isSelected()) {
			...
			this.configBean.removeAdditionalProperty(ReactionEnumeratorActivity.USE_MULTI_MATCH_CHECKER);
		}
		if (this.useVariableRegionCheckerCheckBox.isSelected()) {
			this.configBean.addAdditionalProperty(ReactionEnumeratorActivity.USE_VARIABLE_REGION_CHECKER, true);
		} else {
			this.configBean.removeAdditionalProperty(ReactionEnumeratorActivity.USE_VARIABLE_REGION_CHECKER);
		}
	}
	...
	public void refreshConfiguration() {
		...
		this.useVariableRegionCheckerCheckBox.setSelected(this.configBean
				.getAdditionalProperty(ReactionEnumeratorActivity.USE_VARIABLE_REGION_CHECKER) != null);
		this.useMultiMatchCheckerCheckBox.setSelected(this.configBean
				.getAdditionalProperty(ReactionEnumeratorActivity.USE_MULTI_MATCH_CHECKER) != null);
		this.repaint();
	}
