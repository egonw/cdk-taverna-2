...
public class SplitRegressionTrainTestsetConfigurationPanelController extends
	...
	private SPIRegistry<AbstractRegressionConfigurationFrame> cdkRegressionConfigFramesRegistry = new SPIRegistry<AbstractRegressionConfigurationFrame>(
	...
	public SplitRegressionTrainTestsetConfigurationPanelController(AbstractCDKActivity activity) {
		try {
