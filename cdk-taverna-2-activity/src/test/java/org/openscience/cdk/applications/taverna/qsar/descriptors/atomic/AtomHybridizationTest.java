 ...
 * 
 */
public class AtomHybridizationTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public AtomHybridizationTest() {
		super(AtomHybridization.class);
	}
	...
	public static Test suite() {
		return new TestSuite(AtomDegreeTest.class);
	}
