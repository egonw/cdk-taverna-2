 ...
 * 
 */
public class WeightedPathTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public WeightedPathTest() {
		super(WeightedPath.class);
	}
	...
	public static Test suite() {
		return new TestSuite(WeightedPathTest.class);
	}
