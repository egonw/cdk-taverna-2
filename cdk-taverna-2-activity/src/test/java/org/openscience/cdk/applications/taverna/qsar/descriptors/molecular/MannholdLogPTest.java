 ...
 * 
 */
public class MannholdLogPTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public MannholdLogPTest() {
		super(MannholdLogP.class);
	}
	...
	public static Test suite() {
		return new TestSuite(MannholdLogPTest.class);
	}
