 ...
 * 
 */
public class CovalentRadiusTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor 
	 */
	public CovalentRadiusTest() {
		super(CovalentRadius.class);
	}
	...
	public static Test suite() {
		return new TestSuite(CovalentRadiusTest.class);
	}
