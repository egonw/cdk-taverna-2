...
import org.openscience.cdk.applications.taverna.modelling.CoordinatesGenerator2DAcitivity;
...
public class CoordinatesGenerator2DAcitivityTest extends CDKTavernaTestCases {
	...
	private AbstractCDKActivity activity = new CoordinatesGenerator2DAcitivity();

	public CoordinatesGenerator2DAcitivityTest() {
		super(CoordinatesGenerator2DAcitivity.COORDINATES_GENERATOR_ACTIVITY);
	}

	public void makeConfigBean() throws Exception {
		configBean = new CDKActivityConfigurationBean();
		configBean.setActivityName(CoordinatesGenerator2DAcitivity.COORDINATES_GENERATOR_ACTIVITY);
