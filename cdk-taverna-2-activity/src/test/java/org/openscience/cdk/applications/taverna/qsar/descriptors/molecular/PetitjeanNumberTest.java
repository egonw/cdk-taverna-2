 ...
 * 
 */
public class PetitjeanNumberTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public PetitjeanNumberTest() {
		super(PetitjeanNumber.class);
	}
	...
	public static Test suite() {
		return new TestSuite(PetitjeanNumberTest.class);
	}
