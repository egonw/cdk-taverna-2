 ...
 * 
 */
public class PiElectronegativityTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public PiElectronegativityTest() {
		super(PiElectronegativity.class);
	}
	...
	public static Test suite() {
		return new TestSuite(PiElectronegativityTest.class);
	}
