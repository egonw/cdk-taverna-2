 ...
 * 
 */
public class EccentricConnectivityIndexTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public EccentricConnectivityIndexTest() {
		super(EccentricConnectivityIndex.class);
	}
	...
	public static Test suite() {
		return new TestSuite(EccentricConnectivityIndexTest.class);
	}
