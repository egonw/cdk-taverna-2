 ...
 * 
 */
public class AromaticBondsCountTest extends AbstractDescriptorTestCase {
	
	/**
	 * Constructor which instantiate the testing processor
	 */
	public AromaticBondsCountTest() {
		super(AromaticBondsCount.class);
	}
	...
	public static Test suite() {
		return new TestSuite(AromaticBondsCountTest.class);
	}
