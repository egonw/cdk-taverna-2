 ...
 * 
 */
public class Autocorrelation_PolarizabilityTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public Autocorrelation_PolarizabilityTest() {
		super(Autocorrelation_Polarizability.class);
	}
	...
	public static Test suite() {
		return new TestSuite(Autocorrelation_PolarizabilityTest.class);
	}
