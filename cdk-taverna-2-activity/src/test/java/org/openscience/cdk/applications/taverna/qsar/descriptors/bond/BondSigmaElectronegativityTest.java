 ...
 * 
 */
public class BondSigmaElectronegativityTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public BondSigmaElectronegativityTest() {
		super(BondSigmaElectronegativity.class);
	}
	...
	public static Test suite() {
		return new TestSuite(BondSigmaElectronegativityTest.class);
	}
