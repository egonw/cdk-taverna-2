...
import org.openscience.cdk.applications.taverna.io.SMILESFileWriterActivity;
 ...
 * 
 */
public class IsomorphismTesterActivityTest extends CDKTavernaTestCases {
	...
	public void makeConfigBean() throws Exception {
		...
		configBean.setActivityName(IsomorphismTesterActivity.ISOMORPHISM_TESTER_ACTIVITY);
	}
	...
	public static Test suite() {
		return new TestSuite(IsomorphismTesterActivityTest.class);
	}
