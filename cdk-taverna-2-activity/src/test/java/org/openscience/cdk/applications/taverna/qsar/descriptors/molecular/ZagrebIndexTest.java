 ...
 * 
 */
public class ZagrebIndexTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public ZagrebIndexTest() {
		super(ZagrebIndex.class);
	}
	...
	public static Test suite() {
		return new TestSuite(ZagrebIndexTest.class);
	}
