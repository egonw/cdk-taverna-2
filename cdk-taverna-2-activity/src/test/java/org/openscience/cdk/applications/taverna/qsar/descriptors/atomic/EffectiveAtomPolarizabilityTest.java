 ...
 * 
 */
public class EffectiveAtomPolarizabilityTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public EffectiveAtomPolarizabilityTest() {
		super(EffectiveAtomPolarizability.class);
	}
	...
	public static Test suite() {
		return new TestSuite(EffectiveAtomPolarizabilityTest.class);
	}
