...
/* $RCSfile$
 * $Author: thomaskuhn $
 * $Date: 2008-05-30 14:36:02 +0200 (Fr, 30 Mai 2008) $
 * $Revision: 11229 $
 * 
 ...
 * 
 */
public class IPMolecularLearningTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public IPMolecularLearningTest() {
		super(IPMolecularLearning.class);
	}
	...
	public static Test suite() {
		return new TestSuite(IPMolecularLearningTest.class);
	}
