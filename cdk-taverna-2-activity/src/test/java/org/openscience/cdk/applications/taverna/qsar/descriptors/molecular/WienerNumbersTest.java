 ...
 * 
 */
public class WienerNumbersTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public WienerNumbersTest() {
		super(WienerNumbers.class);
	}
	...
	public static Test suite() {
		return new TestSuite(WienerNumbersTest.class);
	}
