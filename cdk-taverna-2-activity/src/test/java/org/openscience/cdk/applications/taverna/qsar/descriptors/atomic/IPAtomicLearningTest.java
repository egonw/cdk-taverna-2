 ...
 * 
 */
public class IPAtomicLearningTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor 
	 */
	public IPAtomicLearningTest() {
		super(IPAtomicLearning.class);
	}
	...
	public static Test suite() {
		return new TestSuite(IPAtomicLearningTest.class);
	}
