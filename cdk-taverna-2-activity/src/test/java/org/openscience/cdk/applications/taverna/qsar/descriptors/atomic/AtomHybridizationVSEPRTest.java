 ...
 * 
 */
public class AtomHybridizationVSEPRTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public AtomHybridizationVSEPRTest() {
		super(AtomHybridizationVSEPR.class);
	}
	...
	public static Test suite() {
		return new TestSuite(AtomHybridizationVSEPRTest.class);
	}
