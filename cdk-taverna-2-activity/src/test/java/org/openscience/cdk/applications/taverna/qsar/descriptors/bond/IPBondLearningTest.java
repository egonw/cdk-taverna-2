/* $RCSfile$
 * $Author: thomaskuhn $
 * $Date: 2008-05-30 14:35:50 +0200 (Fr, 30 Mai 2008) $
 * $Revision: 11228 $
 * 
 ...
 * 
 */
public class IPBondLearningTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public IPBondLearningTest() {
		super(IPBondLearning.class);
	}
	...
	public static Test suite() {
		return new TestSuite(IPBondLearningTest.class);
	}
