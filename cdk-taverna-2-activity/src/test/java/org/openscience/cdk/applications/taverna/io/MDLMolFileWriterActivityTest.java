...
/**
 * Test class for the MDL Mol file writer activity.
 * 
 * @author Andreas Truszkowski
 * 
 */
public class MDLMolFileWriterActivityTest extends CDKTavernaTestCases {

	private CDKActivityConfigurationBean configBean;

	private AbstractCDKActivity activity = new MDLMolFileWriterActivity();

	private File dir = null;

	public MDLMolFileWriterActivityTest() {
		super(MDLMolFileWriterActivity.MOL_FILE_WRITER_ACTIVITY);
	}
	...
	public void makeConfigBean() throws Exception {
		...
		configBean.addAdditionalProperty(CDKTavernaConstants.PROPERTY_FILE_EXTENSION, ".mol");
