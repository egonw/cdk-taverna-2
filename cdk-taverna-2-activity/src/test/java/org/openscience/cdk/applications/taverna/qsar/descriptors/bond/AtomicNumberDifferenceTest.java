 ...
 * 
 */
public class AtomicNumberDifferenceTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public AtomicNumberDifferenceTest() {
		super(AtomicNumberDifference.class);
	}
	...
	public static Test suite() {
		return new TestSuite(AtomicNumberDifferenceTest.class);
	}
