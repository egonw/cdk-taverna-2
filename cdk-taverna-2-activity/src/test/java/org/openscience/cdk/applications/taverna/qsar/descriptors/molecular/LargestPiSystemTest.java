 ...
 * 
 */
public class LargestPiSystemTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public LargestPiSystemTest() {
		super(LargestPiSystem.class);
	}
	...
	public static Test suite() {
		return new TestSuite(LargestPiSystemTest.class);
	}
