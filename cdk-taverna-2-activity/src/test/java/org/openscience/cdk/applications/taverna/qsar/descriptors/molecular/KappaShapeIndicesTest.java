 ...
 * 
 */
public class KappaShapeIndicesTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public KappaShapeIndicesTest() {
		super(KappaShapeIndices.class);
	}
	...
	public static Test suite() {
		return new TestSuite(KappaShapeIndicesTest.class);
	}
