...
public abstract class AbstractDescriptorTestCase extends CDKTavernaTestCases {
	...
	protected void checkResults() throws Exception {
		...
		// Check whether the naming has worked properly
		// if (resultListCalculatedStructures.size() != 0) {
		// for (CMLChemFile cmlChemFile : this.resultListCalculatedStructures) {
		...
		// }
		// if (!((String) fileName.get(fileName.size() - 1)).equalsIgnoreCase(processorName)) {
		// hasFileNameAnError = true;
		// }
		// }
		// }
