 ...
 * 
 */
public class CarbonTypesTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public CarbonTypesTest() {
		super(CarbonTypes.class);
	}
	...
	public static Test suite() {
		return new TestSuite(CarbonTypesTest.class);
	}
