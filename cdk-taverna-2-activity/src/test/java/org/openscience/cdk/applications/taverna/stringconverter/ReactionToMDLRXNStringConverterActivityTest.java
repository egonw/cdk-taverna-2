 ...
 * 
 */
public class ReactionToMDLRXNStringConverterActivityTest extends CDKTavernaTestCases {
	...
	public void makeConfigBean() throws Exception {
		...
		configBean.setActivityName(ReactionToMDLRXNStringConverterActivity.MDL_RXN_STRING_CONVERTER_ACTIVITY);
	}
	...
	public static Test suite() {
		return new TestSuite(ReactionToMDLRXNStringConverterActivityTest.class);
	}
}
