 ...
 * 
 */
public class KierHallSmartsTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public KierHallSmartsTest() {
		super(KierHallSmarts.class);
	}
	...
	public static Test suite() {
		return new TestSuite(KierHallSmartsTest.class);
	}
