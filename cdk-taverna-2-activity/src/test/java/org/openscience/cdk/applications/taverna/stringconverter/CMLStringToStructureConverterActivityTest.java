...
/**
 * Test class for the CML String to structure converter activity.
 * 
 * @author Andreas Truszkowski
 * 
 */
public class CMLStringToStructureConverterActivityTest extends CDKTavernaTestCases {
	...
	public void makeConfigBean() throws Exception {
		...
		configBean.setActivityName(CMLStringToStructureConverterActivity.CML_STRING_CONVERTER_ACTIVITY);
	}
	...
	public static Test suite() {
		return new TestSuite(CMLStringToStructureConverterActivityTest.class);
	}
