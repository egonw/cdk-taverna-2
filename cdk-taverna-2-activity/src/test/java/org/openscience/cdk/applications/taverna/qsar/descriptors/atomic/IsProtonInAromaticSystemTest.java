 ...
 * 
 */
public class IsProtonInAromaticSystemTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public IsProtonInAromaticSystemTest() {
		super(IsProtonInAromaticSystem.class);
	}
	...
	public static Test suite() {
		return new TestSuite(IsProtonInAromaticSystemTest.class);
	}
