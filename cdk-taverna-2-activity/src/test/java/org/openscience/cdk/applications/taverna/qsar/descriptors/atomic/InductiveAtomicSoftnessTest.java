 ...
 * 
 */
public class InductiveAtomicSoftnessTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public InductiveAtomicSoftnessTest() {
		super(InductiveAtomicSoftness.class);
	...
	public static Test suite() {
		return new TestSuite(InductiveAtomicSoftnessTest.class);
	}
