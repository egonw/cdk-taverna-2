...
/**
 * Test class for the SMILES file reader activity.
 * 
 * @author Andreas Truszkowski
 * 
 */
public class SMILESFileReaderActivityTest extends CDKTavernaTestCases {

	private CDKActivityConfigurationBean configBean;

	private AbstractCDKActivity activity = new SMILESFileReaderActivity();

	public SMILESFileReaderActivityTest() {
		super(SMILESFileReaderActivity.SMILES_FILE_READER_ACTIVITY);
	}
	...
	public void executeAsynch() throws Exception {
		...
		sdTestFile.add("src" + File.separator + "test" + File.separator + "resources" + File.separator + "data"
				+ File.separator + "smiles" + File.separator + "allstructures.smi");
		...
		Assert.assertEquals(5, objectData.size());
	...
	public static Test suite() {
		return new TestSuite(SMILESFileReaderActivityTest.class);
	}
