 ...
 * 
 */
public class AcidicGroupCountTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public AcidicGroupCountTest() {
		super(AcidicGroupCount.class);
	}
	...
	public static Test suite() {
		return new TestSuite(AcidicGroupCountTest.class);
	}
