 ...
 * 
 */
public class IsProtonInConjugatedPiSystemTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public IsProtonInConjugatedPiSystemTest() {
		super(IsProtonInConjugatedPiSystem.class);
	}
	...
	public static Test suite() {
		return new TestSuite(IsProtonInConjugatedPiSystemTest.class);
	}
