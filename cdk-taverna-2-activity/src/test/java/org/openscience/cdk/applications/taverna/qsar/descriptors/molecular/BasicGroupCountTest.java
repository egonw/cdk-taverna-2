 ...
 * 
 */
public class BasicGroupCountTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public BasicGroupCountTest() {
		super(BasicGroupCount.class);
	}
	...
	public static Test suite() {
		return new TestSuite(BasicGroupCountTest.class);
	}
