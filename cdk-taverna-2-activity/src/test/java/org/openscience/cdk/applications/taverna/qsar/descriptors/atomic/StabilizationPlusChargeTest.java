 ...
 * 
 */
public class StabilizationPlusChargeTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public StabilizationPlusChargeTest() {
		super(StabilizationPlusCharge.class);
	}
	...
	public static Test suite() {
		return new TestSuite(StabilizationPlusChargeTest.class);
	}
