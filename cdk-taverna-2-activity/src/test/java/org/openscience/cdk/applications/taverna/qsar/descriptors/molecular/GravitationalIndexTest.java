 ...
 * 
 */
public class GravitationalIndexTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public GravitationalIndexTest() {
		super(GravitationalIndex.class);
	...
	public static Test suite() {
		return new TestSuite(GravitationalIndexTest.class);
	}
