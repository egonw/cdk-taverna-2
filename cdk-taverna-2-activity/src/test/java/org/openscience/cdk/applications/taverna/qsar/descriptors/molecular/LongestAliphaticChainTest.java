 ...
 * 
 */
public class LongestAliphaticChainTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public LongestAliphaticChainTest() {
		super(LongestAliphaticChain.class);
	}
	...
	public static Test suite() {
		return new TestSuite(LongestAliphaticChainTest.class);
	}
