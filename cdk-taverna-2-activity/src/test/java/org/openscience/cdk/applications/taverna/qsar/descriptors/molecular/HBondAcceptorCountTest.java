 ...
 * 
 */
public class HBondAcceptorCountTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public HBondAcceptorCountTest() {
		super(HBondAcceptorCount.class);
	}
	...
	public static Test suite() {
		return new TestSuite(HBondAcceptorCountTest.class);
	}
