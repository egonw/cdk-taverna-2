 ...
 * 
 */
public class RDFProton_GSRTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public RDFProton_GSRTest() {
		super(RDFProton_GSR.class);
	}
	...
	public static Test suite() {
		return new TestSuite(RDFProton_GSRTest.class);
	}
