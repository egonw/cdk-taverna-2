...
import org.openscience.cdk.applications.taverna.reactionenumerator.ReactionEnumeratorSubgraphFilterActivity;
import org.openscience.cdk.interfaces.IAtomContainer;
import org.openscience.cdk.io.MDLReader;

/**
 * Test class for the reaction enumerator subgraph tester activity.
 * 
 * @author Andreas Truszkowski
 * 
 */
public class ReactionEnumeratorSubgraphFilterActivityTest extends CDKTavernaTestCases {

	private CDKActivityConfigurationBean configBean;

	private AbstractCDKActivity activity = new ReactionEnumeratorSubgraphFilterActivity();

	public ReactionEnumeratorSubgraphFilterActivityTest() {
		super(ReactionEnumeratorSubgraphFilterActivity.REACTION_ENUMERATOR_SUBGRAPH_FILTER_ACTIVITY);
	}
	...
	public void executeAsynch() throws Exception {
		...
		String testFile = "src" + File.separator + "test" + File.separator + "resources" + File.separator + "data"
	...
	public static Test suite() {
		return new TestSuite(ReactionEnumeratorSubgraphFilterActivityTest.class);
	}
