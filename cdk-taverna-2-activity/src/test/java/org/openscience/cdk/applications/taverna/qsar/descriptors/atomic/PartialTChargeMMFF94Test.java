 ...
 * 
 */
public class PartialTChargeMMFF94Test extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public PartialTChargeMMFF94Test() {
		super(PartialTChargeMMFF94.class);
	}
	...
	public static Test suite() {
		return new TestSuite(PartialTChargeMMFF94Test.class);
	}
