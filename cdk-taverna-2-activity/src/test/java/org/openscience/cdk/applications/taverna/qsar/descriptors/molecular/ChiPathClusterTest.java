 ...
 * 
 */
public class ChiPathClusterTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public ChiPathClusterTest() {
		super(ChiPathCluster.class);
	}
	...
	public static Test suite() {
		return new TestSuite(ChiPathClusterTest.class);
	}
