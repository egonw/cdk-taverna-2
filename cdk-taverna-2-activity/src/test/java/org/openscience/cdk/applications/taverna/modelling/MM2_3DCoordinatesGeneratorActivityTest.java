 ...
 */
public class MM2_3DCoordinatesGeneratorActivityTest extends CDKTavernaTestCases {

	private CDKActivityConfigurationBean configBean;
	private AbstractCDKActivity activity = new MM2_3DCoordinatesGeneratorActivity();

	public MM2_3DCoordinatesGeneratorActivityTest() {
		super(MM2_3DCoordinatesGeneratorActivity.MM2_3D_COORDINATES_GENERATOR_ACTIVITY);
	}

	public void makeConfigBean() throws Exception {
		configBean = new CDKActivityConfigurationBean();
		configBean.setActivityName(MM2_3DCoordinatesGeneratorActivity.MM2_3D_COORDINATES_GENERATOR_ACTIVITY);
	...
	public static Test suite() {
		return new TestSuite(MM2_3DCoordinatesGeneratorActivityTest.class);
	}
}
