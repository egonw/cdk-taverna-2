 ...
 * 
 */
public class Autocorrelation_MassTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public Autocorrelation_MassTest() {
		super(Autocorrelation_Mass.class);
	}
	...
	public static Test suite() {
		return new TestSuite(Autocorrelation_MassTest.class);
	}
