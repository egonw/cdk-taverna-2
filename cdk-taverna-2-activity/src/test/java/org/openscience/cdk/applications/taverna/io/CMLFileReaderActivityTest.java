...
/**
 * Test class for the CML file reader activity.
 * 
 * @author Andreas Truszkowski
 * 
 */
public class CMLFileReaderActivityTest extends CDKTavernaTestCases {

	private CDKActivityConfigurationBean configBean;

	private AbstractCDKActivity activity = new CMLFileReaderActivity();

	public CMLFileReaderActivityTest() {
		super(CMLFileReaderActivity.CML_FILE_READER_ACTIVITY);
	}
	...
	public void executeAsynch() throws Exception {
		...
		sdTestFile.add("src" + File.separator + "test" + File.separator + "resources" + File.separator
		...
		Assert.assertEquals(3, objectData.size());
	...
	public static Test suite() {
		return new TestSuite(CMLFileReaderActivityTest.class);
	}
