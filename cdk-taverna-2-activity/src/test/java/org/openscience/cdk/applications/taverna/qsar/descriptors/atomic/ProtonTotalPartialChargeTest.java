 ...
 * 
 */
public class ProtonTotalPartialChargeTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public ProtonTotalPartialChargeTest() {
		super(ProtonTotalPartialCharge.class);
	}
	...
	public static Test suite() {
		return new TestSuite(ProtonTotalPartialChargeTest.class);
	}
