 ...
 * 
 */
public class MomentOfInertiaTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public MomentOfInertiaTest() {
		super(MomentOfInertia.class);
	...
	public static Test suite() {
		return new TestSuite(MomentOfInertiaTest.class);
	}
