 ...
 * 
 */
public class HybridizationRatioTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public HybridizationRatioTest() {
		super(HybridizationRatio.class);
	}
	...
	public static Test suite() {
		return new TestSuite(HybridizationRatioTest.class);
	}
