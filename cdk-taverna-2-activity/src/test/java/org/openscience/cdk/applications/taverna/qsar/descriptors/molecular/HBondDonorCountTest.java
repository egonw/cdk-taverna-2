 ...
 * 
 */
public class HBondDonorCountTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public HBondDonorCountTest() {
		super(HBondDonorCount.class);
	}
	...
	public static Test suite() {
		return new TestSuite(HBondDonorCountTest.class);
	}
