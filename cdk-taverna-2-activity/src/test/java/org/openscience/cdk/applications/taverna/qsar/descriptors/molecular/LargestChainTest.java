 ...
 * 
 */
public class LargestChainTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public LargestChainTest() {
		super(LargestChain.class);
	}
	...
	public static Test suite() {
		return new TestSuite(LargestChainTest.class);
	}
