 ...
 * 
 */
public class RotatableBondsCountTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public RotatableBondsCountTest() {
		super(RotatableBondsCount.class);
	}
	...
	public static Test suite() {
		return new TestSuite(RotatableBondsCountTest.class);
	}
