 ...
 * 
 */
public class FragmentComplexityTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public FragmentComplexityTest() {
		super(FragmentComplexity.class);
	}
	...
	public static Test suite() {
		return new TestSuite(FragmentComplexityTest.class);
	}
