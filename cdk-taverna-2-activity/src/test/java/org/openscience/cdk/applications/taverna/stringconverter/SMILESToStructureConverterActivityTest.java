 ...
 * 
 */
public class SMILESToStructureConverterActivityTest extends CDKTavernaTestCases {

	private CDKActivityConfigurationBean configBean;

	private AbstractCDKActivity activity = new SMILESToStructureConverterActivity();

	public SMILESToStructureConverterActivityTest() {
		super(SMILESToStructureConverterActivity.SMILES_CONVERTER_ACTIVITY);
	}

	public void makeConfigBean() throws Exception {
		configBean = new CDKActivityConfigurationBean();
		configBean.setActivityName(SMILESToStructureConverterActivity.SMILES_CONVERTER_ACTIVITY);
	}
	...
	public static Test suite() {
		return new TestSuite(SMILESToStructureConverterActivityTest.class);
	}
