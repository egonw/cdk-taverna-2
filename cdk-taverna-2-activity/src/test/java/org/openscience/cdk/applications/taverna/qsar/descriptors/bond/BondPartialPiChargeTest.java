 ...
 * 
 */
public class BondPartialPiChargeTest extends AbstractDescriptorTestCase {

	/**
	 * Constructor which instantiate the testing processor
	 */
	public BondPartialPiChargeTest() {
		super(BondPartialPiCharge.class);
	}
	...
	public static Test suite() {
		return new TestSuite(BondPartialPiChargeTest.class);
	}
