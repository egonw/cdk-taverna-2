 ...
 * 
 */
public class LeaveOneOutRAttributeSelectionActivity extends AbstractLeaveOneOutAttributeSelectionActivity {

	/**
	 * Creates a new instance.
	 */
	public LeaveOneOutRAttributeSelectionActivity() {
