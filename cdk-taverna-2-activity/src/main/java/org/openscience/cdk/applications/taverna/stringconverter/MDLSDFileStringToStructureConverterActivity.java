...
/**
 * Class which represents the MDL SDFile String to structure converter activity.
 * 
...
public class MDLSDFileStringToStructureConverterActivity extends AbstractCDKActivity {
	...
	public void work() throws Exception {
		// Get input
		List<String> sdfList = this.getInputAsList(this.INPUT_PORTS[0], String.class);
		// Do work
		...
		for (String sdf : sdfList) {
			try {
				...
				tmpMDLReader.close();
				cmlChemFileList.addAll(CMLChemFileWrapper.wrapInChemModelList(chemFile));
			} catch (Exception e) {
	...
	public String getActivityName() {
		return MDLSDFileStringToStructureConverterActivity.MDL_SDFILE_STRING_CONVERTER_ACTIVITY;
	}
	...
	public String getDescription() {
		return "Description: " + MDLSDFileStringToStructureConverterActivity.MDL_SDFILE_STRING_CONVERTER_ACTIVITY;
	}
