...
/**
 * Class which represents the ARFF file reader activity.
 * 
...
public class ARFFFileReaderActivity extends AbstractCDKActivity {
	...
	public String getActivityName() {
		return ARFFFileReaderActivity.ARFF_FILE_READER_ACTIVITY;
	}
	...
	public String getDescription() {
		return "Description: " + ARFFFileReaderActivity.ARFF_FILE_READER_ACTIVITY;
	}
