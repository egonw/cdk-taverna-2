...
public class Art2aClassificator {
	 ...
	 * 
	 * @param objects
	 *            Array of objects to be classified. All objects must implement the FingerprintItem interface. Each
...
//			reader.next();
	 ...
	 * Get-Property
	 * 
	 * @return True / false, depending on whether the random should be deterministic or not.
	 */
