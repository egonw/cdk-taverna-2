 ...
 * 
 */
public class SubgraphIsomorphismFilterActivity extends AbstractCDKActivity {
	...
	public String getActivityName() {
		return SubgraphIsomorphismFilterActivity.SUBGRAPHISOMORPHISM_FILTER_ACTIVITY;
	}

	@Override
	public String getDescription() {
		return "Descriptions: " + SubgraphIsomorphismFilterActivity.SUBGRAPHISOMORPHISM_FILTER_ACTIVITY;
	}
