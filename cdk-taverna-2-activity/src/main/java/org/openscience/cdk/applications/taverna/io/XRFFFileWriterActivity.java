...
/**
 * Class which represents the XRFF file writer activity.
 * 
 * @author Andreas Truzskowski
 * 
 */
public class XRFFFileWriterActivity extends AbstractCDKActivity {

	public static final String XRFF_FILE_WRITER_ACTIVITY = "XRFF File Writer";

	/**
	 * Creates a new instance.
	 */
	public XRFFFileWriterActivity() {
	...
	public String getActivityName() {
		return XRFFFileWriterActivity.XRFF_FILE_WRITER_ACTIVITY;
	}

	@Override
	public HashMap<String, Object> getAdditionalProperties() {
		HashMap<String, Object> properties = new HashMap<String, Object>();
		properties.put(CDKTavernaConstants.PROPERTY_FILE_EXTENSION, ".xrff");
		return properties;
	}

	@Override
	public String getDescription() {
		return "Description: " + XRFFFileWriterActivity.XRFF_FILE_WRITER_ACTIVITY;
	}
