...
public class StructureToCMLStringConverterActivity extends AbstractCDKActivity {
	...
	public StructureToCMLStringConverterActivity() {
		...
		this.OUTPUT_PORTS = new String[] { "CML String", "Not Converted" };
	}
	...
	public void work() throws Exception {
		...
		// Set input
		this.setOutputAsStringList(cmlStringList, this.OUTPUT_PORTS[0]);
		this.setOutputAsObjectList(notConverted, this.OUTPUT_PORTS[1]);
	}

	@Override
	public String getActivityName() {
		return StructureToCMLStringConverterActivity.CML_STRING_CONVERTER_ACTIVITY;
	}
	...
	public String getDescription() {
		return "Description: " + StructureToCMLStringConverterActivity.CML_STRING_CONVERTER_ACTIVITY;
	}
