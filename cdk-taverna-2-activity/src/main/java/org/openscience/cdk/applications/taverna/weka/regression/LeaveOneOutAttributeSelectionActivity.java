...
import org.openscience.cdk.applications.taverna.weka.utilities.HeuristicAttributeEvaluationWorker;
 ...
 * 
 */
public class LeaveOneOutAttributeSelectionActivity extends AbstractCDKActivity {

	public static final String HEURISTIC_ATTRIBUTE_SELECTION_ACTIVITY = "Leave-One-Out Attribute Selection";

	private HeuristicAttributeEvaluationWorker[] workers = null;
	 ...
	 */
	public LeaveOneOutAttributeSelectionActivity() {
	...
	public void work() throws Exception {
		...
		for (int i = 0; i < dataset.numAttributes() - 3; i++) {
			...
			this.workers = new HeuristicAttributeEvaluationWorker[threads];
			for (int j = 0; j < this.workers.length; j++) {
				this.workers[j] = new HeuristicAttributeEvaluationWorker(this);
	...
	public synchronized void workerDone() {
		...
		for (HeuristicAttributeEvaluationWorker worker : this.workers) {
			if (!worker.isDone()) {
				allDone = false;
				break;
			}
	...
	public String getActivityName() {
		return LeaveOneOutAttributeSelectionActivity.HEURISTIC_ATTRIBUTE_SELECTION_ACTIVITY;
	}
	...
	public String getDescription() {
		return "Description: " + LeaveOneOutAttributeSelectionActivity.HEURISTIC_ATTRIBUTE_SELECTION_ACTIVITY;
	}
