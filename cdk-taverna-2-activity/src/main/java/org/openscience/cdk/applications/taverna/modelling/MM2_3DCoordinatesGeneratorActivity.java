...
/**
 * Class which represents the MM2 3D-Coordinates Generator activity.
 * 
 * @author Andreas Truszkowski
 * 
 */
public class MM2_3DCoordinatesGeneratorActivity extends AbstractCDKActivity {

	public static final String MM2_3D_COORDINATES_GENERATOR_ACTIVITY = "MM2 3D-Coordinates Generator";

	/**
	 * Creates a new instance.
	 */
	public MM2_3DCoordinatesGeneratorActivity() {
	...
	public String getActivityName() {
		return MM2_3DCoordinatesGeneratorActivity.MM2_3D_COORDINATES_GENERATOR_ACTIVITY;
	}

	@Override
	public String getDescription() {
		return "Descriptions: " + MM2_3DCoordinatesGeneratorActivity.MM2_3D_COORDINATES_GENERATOR_ACTIVITY;
	}
	...
	public void work() throws Exception {
		...
		try {
			descriptor = ModelBuilder3D.getInstance(TemplateHandler3D.getInstance(), "mm2");
		} catch (Exception e) {
